      ...
      <div className="flex max-w-[500px] flex-col justify-center gap-y-4 p-2">
        ...
        <div className={"flex flex-col rounded-lg border border-[#e8ebe5]"}>
          <div className={`flex items-center justify-start p-3`}>
            <Image src={`/matic-logo.png`} height={20} width={20} alt = "image"/>
          </div>
          <Image
            ...
            width={500}
            height={500}
            alt={nft?.asset?.name?.toString() || 'image'}
            objectFit={"cover"}
          />
        </div>
        ...
        <div className={"flex flex-col rounded-lg border border-[#e8ebe5]"}>
          <div className={"border-b border-[#e8ebe5] p-3"}>
            ...
            >
              ...
              <p>Sale ends November 26, 2023 at 7:39pm GMT+11</p>
            </div>
          </div>
          <div className={"flex flex-col gap-y-2 bg-slate-50 p-3"}>
            <div className={"text-sm text-gray-500"}>Current Price</div>
            <div className={`flex items-center space-x-3`}>
              <Image src={`/matic-logo.png`} height={24} width={24} alt = "logo"/>
